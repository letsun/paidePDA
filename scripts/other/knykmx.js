$(function () {
    ...
    $('.gd-add-img').on('click', function () {
        ...
        html += ' <div class="gd-key">货主名称</div>';
        html += ' <input type="text" class="gd-val inStock" data-validateInfor="{strategy:isEmpty,msg:申请库存不能为空}">';
        ...
        html += '<div class="gd-key">移库数量</div>';
        html += '<div class="gd-val storeroomText" data-validateInfor="{strategy:isEmpty,msg:移库数量不能为空}|{strategy:isNumber,msg:移库数量}"></div>';

        html += '<img class="gd-img " src="../img/1_34.png" >';
        html += '</div>';

        html += '<div class="gd-item showReservoirArea">';
        html += '<div class="gd-key">移库重量(吨)</div>';
        html += '<div class="gd-val reservoirAreaText" data-validateInfor="{strategy:isEmpty,msg:移库重量不能为空}|{strategy:isNumber,msg:移库重量}"></div>';
